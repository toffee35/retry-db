By contributing code to the RetryDB project in any form you agree to the RetryDB Software Grant and
Contributor License Agreement attached below. Only contributions made under the RetryDB Software Grant
and Contributor License Agreement may be accepted by toffee35, and any contribution is subject to the
terms of the RetryDB dual-license under RSALv2/SSPLv1 as described in the LICENSE.txt file included in
the RetryDB source distribution.

# RETRYDB SOFTWARE GRANT AND CONTRIBUTOR LICENSE AGREEMENT

To specify the intellectual property license granted in any Contribution, the project maintainer, toffee35 ("**toffee35**")
requires a Software Grant and Contributor License Agreement ("**Agreement**"). This Agreement is for
your protection as a contributor as well as the protection of toffee35 and its users; it does not
...
Contribution. Except for the license granted in this Agreement to toffee35 and the recipients of the
software distributed by toffee35, You reserve all right, title, and interest in and to Your
Contribution.

1. **Definitions**

    1.1. "**You**" (or "**Your**") means the copyright owner or legal entity authorized by the
    copyright owner that is entering into this Agreement with toffee35. For legal entities, the entity
...
2. "**Work**" means any software project stewarded by toffee35.

3. **Grant of Copyright License**. Subject to the terms and conditions of this Agreement, You grant
   to toffee35 and to the recipients of the software distributed by toffee35 a perpetual, worldwide,
...
4. **Grant of Patent License**. Subject to the terms and conditions of this Agreement, You grant to
   toffee35 and to the recipients of the software distributed by toffee35 a perpetual, worldwide,
...
7. **Enforceability**. Nothing in this Agreement will be construed as creating any joint venture,
   employment relationship, or partnership between You and toffee35. If any provision of this Agreement
   is held to be unenforceable, the remaining provisions of this Agreement will not be affected.
   This represents the entire agreement between You and toffee35 relating to the Contribution.

# IMPORTANT: HOW TO USE RETRYDB GITHUB ISSUES

GitHub issues SHOULD ONLY BE USED to report bugs and for DETAILED feature
requests. If you have general questions, please open a GitHub Discussion in 
the repository.
...
2. If in step 1 you get an acknowledgment from the project leaders, use the
   following procedure to submit a patch:
    ...
    a. Fork RetryDB on GitHub ( https://docs.github.com/en/github/getting-started-with-github/fork-a-repo )
